      ...
      >
        ...
        >
          ...
          <div className="space-y-2 mb-4">
            <h2 className="text-2xl font-semibold">Thank you for exploring our Password Security Project.</h2>
            <p className="text-sm leading-relaxed max-w-3xl text-stone-600 dark:text-stone-300">
          ...
          {/* References (APA) */}
          <div className="mt-8 grid gap-4 sm:grid-cols-2 text-sm text-stone-600 dark:text-stone-300">
            <div>
              <p className="uppercase tracking-wider text-xs">References (APA)</p>

              <p className="mt-2">
                International Organization for Standardization. (2018). <em>
                ISO/IEC 27000:2018 — Information technology — Security techniques —
                Information security management systems — Overview and vocabulary</em>.
                ISO.
              </p>
            </div>
            ...
            <div>
              <p className="mt-2">
                International Organization for Standardization. (2022). <em>
                ISO/IEC 27002:2022 — Information security, cybersecurity and privacy
                protection — Information security controls</em>.
                ISO.
              </p>
            </div>
          </div>
